    ...
    <div className="main">
      ...
      <div className="main-container2">
        <div className="txt-btn">
          <p>
            Con Drops Argentina podrás acceder a los productos más competitivos
            del mercado, con la facildad y en la comodidad de tu hogar. Es muy
            fácil, entras, seleccionas tus productos y lo llevamos a tu puerta
            sin cargo!{" "}
          </p>
